...
import { AriaStageFluidA } from "./stage/aria-stage-fluid-a";
...
import { AriaStageSphere } from "./stage/aria-stage-sphere";
...
import { AriaStageWaterwave } from "./stage/aria-stage-water-wave";
...
async function main(){
    ...
    const chosenStage = (()=>{
        ...
        const stagePair = [
            ...
            {key:"fluid", stage:AriaStageFluidA, name:"Fluid Simulation with Caustics"},
            {key:"sphere", stage:AriaStageSphere, name:"Sphere"},
        ]
