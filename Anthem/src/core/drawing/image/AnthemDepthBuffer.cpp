...
namespace Anthem::Core{
    bool AnthemDepthBuffer::createDepthBuffer(){
        this->createImageInternal(VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT,this->depthFormat,this->swapChain->getSwapChainExtentWidth(),this->swapChain->getSwapChainExtentHeight(),1);
