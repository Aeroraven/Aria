...
export class AriaAssetLoader{
    ...
    private async load(){
        ...
        const shaderLists = [
            ...
            {name:"trivial",v:"./shaders/%name%/vertex.glsl",f:"./shaders/%name%/fragment.glsl"},
            {name:"fluid/scene",v:"./shaders/%name%/vertex.glsl",f:"./shaders/%name%/fragment.glsl"},
            {name:"fluid/floor",v:"./shaders/%name%/vertex.glsl",f:"./shaders/%name%/fragment.glsl"},
            {name:"fluid/kdepth",v:"./shaders/%name%/vertex.glsl",f:"./shaders/%name%/fragment.glsl"},
            {name:"fluid/depth",v:"./shaders/%name%/vertex.glsl",f:"./shaders/%name%/fragment.glsl"},
            {name:"fluid/surface",v:"./shaders/%name%/vertex.glsl",f:"./shaders/%name%/fragment.glsl"},
            {name:"fluid/caustics",v:"./shaders/%name%/vertex.glsl",f:"./shaders/%name%/fragment.glsl"},
        ]
