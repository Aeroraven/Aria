...
export class AriaComFramebuffer extends AriaComponent implements IAriaGLBuffer<WebGLFramebuffer>, IAriaTextureAttached{
    private gl:WebGL2RenderingContext
    private fb:WebGLFramebuffer
    private tex:WebGLTexture
    private rbo:WebGLRenderbuffer
    private options:AriaFramebufferOption
    private texWrapper: AriaComTexture = new AriaComTexture()
